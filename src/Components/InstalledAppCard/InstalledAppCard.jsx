        ...
        <div className='bg-white flex flex-col md:flex-row gap-4 justify-between items-start md:items-center px-2 py-3 md:p-4 rounded-sm'>
            <div className='flex gap-3 items-start lg:items-center'>
                ...
                <div className='flex-1 flex flex-col gap-1 lg:gap-4'>
                        <h2 className='font-medium text-[#001931]'>Forest: Focus for Productivity</h2>
                    <div className='flex gap-4'>
                        <div className='flex items-center gap-1'>
                            <Download size={16} color="#00D390" />
                            <span className='font-medium text-[#00D390]'>9M</span>
                        </div>
                        <div className='flex items-center gap-1'>
                        ...
                        <div>
                                <span className='text-[#627382] font-medium'>258 MB</span>
                        </div>
                    </div>
                </div>
            </div>
            <button className='btn bg-[#00D390] w-full md:w-fit text-white'>Uninstall</button>
        </div>
    );
};
